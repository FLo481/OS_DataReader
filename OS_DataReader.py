...
def calc_ang_res():
    ...
    plt.errorbar(x_plt, y_plt, yerr = y_err, fmt = 'x', markersize = 8, label = '150 l/mm grating', elinewidth = .5, capsize = 2)
    plt.errorbar(x_plt1, y_plt1, yerr = y_err1, fmt = 'x', markersize = 8, label = '300 l/mm grating', elinewidth = .5, capsize = 2)
    plt.errorbar(x_plt2, y_plt2, yerr = y_err2, fmt = 'x', markersize = 8, label = '1200 l/mm grating', elinewidth = .5, capsize = 2)
